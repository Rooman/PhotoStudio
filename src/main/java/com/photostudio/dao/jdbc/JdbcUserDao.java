...
public class JdbcUserDao implements UserDao {
    ...
    private static final String GET_ALL_USERS = "SELECT id,email,userRoleId,passwordHash,salt, phoneNumber, gender,firstName,lastName,country,city,zip,street,buildingNumber FROM photostudio.Users;";
    private static final String ADD_NEW_USER = "INSERT INTO users (email,userRoleId, phoneNumber, gender,firstName,lastName,country,city,zip,street,buildingNumber) VALUES (?, ?, ?, ?, ?,?,?, ?, ?, ?, ?)";
    private static final String EDIT_USER = "UPDATE products SET email = ?, userRoleId = ?,phoneNumber = ?,gender = ?,firstName = ?,lastName = ?,country = ?, city = ?, zip=?,street=?, buildingNumber=? WHERE id = ?";
    private static final String GET_USER_BY_ID = "SELECT email,userRole,passwordHash,salt, phoneNumber, gender,firstName,lastName,country,city,zip,street,buildingNumber FROM users WHERE id = ?";
