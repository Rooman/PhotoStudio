...
public class StatisticPreparedStatement implements PreparedStatement {
    PreparedStatement preparedStatement;

    StatisticPreparedStatement(PreparedStatement preparedStatement) {
    ...
    public ResultSet executeQuery() throws SQLException {
        ...
        statisticsVo.addExecutedTime(end - start);
        return resultSet;
    }
